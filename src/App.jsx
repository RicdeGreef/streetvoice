...
// BELANGRIJK: Zorg dat je een 'assets' map in je 'src' map hebt,
// en dat de bestandsnamen van de afbeeldingen overeenkomen.
import situationImage1 from './assets/grappige-foto.png';
import situationImage2 from './assets/bikini-foto.png';
import situationImage3 from './assets/naaktfoto.png';
...
const situations = [
  {
    id: 1,
    title: "Situatie 1",
    description: "Je krijgt een grappige selfie van een vriend(in) en besluit die door te sturen in de groepsapp zonder eerst te vragen.",
    image: situationImage1,
    scaleLabels: { left: "Onschuldig", right: "Schadelijk" },
    mockClassData: { average: 3.5, distribution: { '1-3': 90, '4-7': 10, '8-10': 0 } },
    perspectives: [
        { id: 'ontvanger', title: 'Perspectief van de vriend(in)', description: 'Ik schrok ervan dat mijn foto ineens in die groep stond zonder dat ik het wist.' },
        { id: 'dader', title: 'Gedachtegang van de deler', description: 'Het was maar een grapje, iedereen stuurt toch wel eens wat door? Stelt niks voor.' }
    ]
  },
  {
    id: 2,
    title: "Situatie 2",
    description: "Iemand stuurt jou een foto in bikini/zwembroek bedoeld voor jou alleen. Je twijfelt of je die met een paar vrienden deelt 'voor de grap'.",
    image: situationImage2,
    scaleLabels: { left: "Onschuldig", right: "Schadelijk" },
    mockClassData: { average: 6.5, distribution: { '1-3': 10, '4-7': 30, '8-10': 60 } },
    perspectives: [
        { id: 'ontvanger', title: 'Perspectief van de zender', description: 'Ik stuurde die foto in vertrouwen en zou me verraden voelen als die wordt doorgestuurd.' },
        { id: 'dader', title: 'Gedachtegang van de deler', description: "Wow, even aan m'n beste vrienden laten zien. Niemand komt erachter, het blijft onder ons." }
    ]
  },
  {
    id: 3,
    title: "Situatie 3",
    description: "Je ontvangt een naaktfoto van iemand. Zonder toestemming besluit je deze door te sturen naar anderen.",
    image: situationImage3,
    scaleLabels: { left: "Onschuldig", right: "Schadelijk" },
    mockClassData: { average: 9.2, distribution: { '1-3': 2, '4-7': 8, '8-10': 90 } },
    perspectives: [
        { id: 'ontvanger', title: 'Perspectief van de persoon op de foto', description: 'Dit is extreem pijnlijk en schadelijk. Mijn privacy is compleet geschonden.' },
        { id: 'dader', title: 'Gedachtegang van de deler', description: 'Dit is te heftig om voor mezelf te houden, anderen moeten dit zien. Wat een idioot om dit te sturen, eigen schuld.' }
    ]
  }
];
...
export default function App() {
  ...
  const renderContent = () => {
    switch (step) {
      ...
      case 'rating':
        return <RatingScreen situation={currentSituation} onSubmit={handleRatingSubmit} />;
      case 'results':
        return <ResultsScreen situation={currentSituation} onContinue={handleShowPerspectives} />;
      case 'perspectives':
        return <PerspectiveScreen situation={currentSituation} onContinue={handleNextSituation} isLast={currentSituationIndex === situations.length - 1} />;
      default:
        return null;
    }
  };
...
function RatingScreen({ situation, onSubmit }) {
  ...
  return (
    <div className="screen animate-fade-in">
      ...
      <img src={situation.image} alt={situation.title} className="situation-image" />
